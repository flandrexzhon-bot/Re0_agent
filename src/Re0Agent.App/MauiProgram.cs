...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddScoped<PacingFixtureEvaluator>();
        builder.Services.AddScoped<PacingComparisonService>();
        builder.Services.AddScoped<SceneDirector>();
        builder.Services.AddScoped<DirectorPulseScheduler>();
        builder.Services.AddScoped<DirectorPulseProcessor>();
        builder.Services.AddScoped<DirectorPulseConsumer>();
        builder.Services.AddSingleton<DirectorPulseCoordinator>();
        ...
        builder.Services.AddScoped<RevealQueueProjector>();
        ...
        builder.Services.AddSingleton<IMemoryEmbeddingProvider, FeatureHashMemoryEmbeddingProvider>();
        builder.Services.AddScoped<InformationGate>();
        builder.Services.AddScoped<KnowledgePropagationService>();
        builder.Services.AddScoped<ContinuousModeDiagnosticsService>();
